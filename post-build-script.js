...
const importStatement = `import * as farmhash from '../bin/nodejs/farmhash_wasm.js';`;
...
writeFileSync(
  ...
  src
    ...
    .join(`const farmhash = require('../bin/nodejs/farmhash_wasm.js')`)
...
writeFileSync(
  ...
  src
    .split(importStatement)
    .join(`import * as farmhash from '../bin/bundler/farmhash_wasm.js';`),
);
